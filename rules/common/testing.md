...
3. **E2E Tests** - Critical user flows - use **web-e2e-tester**
...
|---|---|---|
| **Feature** | After implementation (Phase 4) | Use **tester** for unit + integration, **web-e2e-tester** for E2E |
...
- **web-e2e-tester** - E2E tests for critical user flows
